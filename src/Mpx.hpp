...
#else
#define LOG_DEBUG(tag, format, ...) printf("[%s] " format "\n", tag, ##__VA_ARGS__)
#endif
#endif
...
public:
  ...
  [[nodiscard]] float *get_data_buffer() noexcept { return data_buffer_; };
  [[nodiscard]] const float *get_data_buffer() const noexcept { return data_buffer_; };
  [[nodiscard]] float *get_matrix() noexcept { return vmatrix_profile_; };
  [[nodiscard]] const float *get_matrix() const noexcept { return vmatrix_profile_; };
  [[nodiscard]] int16_t *get_indexes() noexcept { return vprofile_index_; };
  [[nodiscard]] const int16_t *get_indexes() const noexcept { return vprofile_index_; };
  [[nodiscard]] float *get_floss() noexcept { return floss_; };
  [[nodiscard]] const float *get_floss() const noexcept { return floss_; };
  [[nodiscard]] float *get_iac() noexcept { return iac_; };
  [[nodiscard]] const float *get_iac() const noexcept { return iac_; };
  [[nodiscard]] float *get_vmmu() noexcept { return vmmu_; };
  [[nodiscard]] const float *get_vmmu() const noexcept { return vmmu_; };
  [[nodiscard]] float *get_vsig() noexcept { return vsig_; };
  [[nodiscard]] const float *get_vsig() const noexcept { return vsig_; };
  [[nodiscard]] float *get_ddf() noexcept { return vddf_; };
  [[nodiscard]] const float *get_ddf() const noexcept { return vddf_; };
  [[nodiscard]] float *get_ddg() noexcept { return vddg_; };
  [[nodiscard]] const float *get_ddg() const noexcept { return vddg_; };
  [[nodiscard]] float *get_vww() noexcept { return vww_; };
  [[nodiscard]] const float *get_vww() const noexcept { return vww_; };
...
private:
  ...
  // arrays
  float *data_buffer_;
  float *vmatrix_profile_;
  int16_t *vprofile_index_;
  float *floss_;
  float *iac_;
  float *vmmu_;
  float *vsig_;
